...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Ananda')
    ...
    GAME_SPRITES['gameOver'] = pygame.image.load(
        'gallery/sprites/game_over.png').convert_alpha()
    # Game sounds
    ...
    GAME_SOUNDS['gameOver'] = pygame.mixer.Sound('gallery/audio/over.mp3')
